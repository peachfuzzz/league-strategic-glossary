  ...
  return (
    <div className="bg-paper flex-1">
      <div className="max-w-2xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-display text-ink mb-8">Credits</h1>

        <div className="space-y-8">
          <section>
            <h2 className="text-lg font-display text-ink mb-4">Contributors</h2>
            <ul className="space-y-3">
              <li className="text-ink-2">
                <a
                  ...
                  className="text-signal hover:text-signal-2 transition-colors underline underline-offset-2"
                >
                  steffnstuff
                </a>
          ...
          <section className="pt-4 border-t border-rule">
            <h2 className="text-lg font-display text-ink mb-4">Inspiration</h2>
